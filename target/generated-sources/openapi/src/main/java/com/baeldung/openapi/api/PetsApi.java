...
public interface PetsApi {
    ...
    default ResponseEntity<List<Pet>> _listPets(@ApiParam(value = "How many items to return at one time (max 100)") @Valid @RequestParam(value = "limit", required = false) Integer limit
    ...
    default ResponseEntity<Pet> _showPetById(@ApiParam(value = "The id of the pet to retrieve", required = true) @PathVariable("petId") String petId
